        ...
        meta: {
          ...
          type: {
            ...
            asDoubleMap: {
              ...
              key2Hasher: new _types.StorageHasher(registry, 'Twox128')
            }
          }
        }
      }, {
      ...
      meta: {
        type: {
          ...
          asDoubleMap: {
            ...
            key2Hasher: new _types.StorageHasher(registry, 'Blake2_256')
          }
        }
      }
    }, {
    ...
    const storageFn = (0, _createFunction.default)(registry, {
      ...
      meta: {
        type: {
          isDoubleMap: true,
          asDoubleMap: {
            hasher: new _types.StorageHasher(registry, 'Twox64Concat'),
