      ...
      storageFn = (0, _createFunction.default)(registry, {
        ...
        meta: {
          ...
          type: {
            isDoubleMap: true,
            asDoubleMap: {
              hasher: (0, _types.createType)(registry, 'StorageHasher', 'Blake2_256'),
              key1: new _types.Text(registry, 'AccountId'),
              key2: new _types.Text(registry, 'AccountId'),
              value: new _types.Text(registry, 'Balance'),
              key2Hasher: (0, _types.createType)(registry, 'StorageHasher', 'Twox128')
            }
          }
        }
      }, {
      ...
      meta: {
        type: {
          ...
          asDoubleMap: {
            ...
            key2Hasher: (0, _types.createType)(registry, 'StorageHasher', 'Blake2_256')
          }
        }
      }
    }, {
    ...
    const storageFn = (0, _createFunction.default)(registry, {
      ...
      meta: {
        type: {
          isDoubleMap: true,
          asDoubleMap: {
            hasher: (0, _types.createType)(registry, 'StorageHasher', 'Twox64Concat'),
