...
const HASHERS = {
  Blake2_128: data => // eslint-disable-line @typescript-eslint/camelcase
  (0, _utilCrypto.blake2AsU8a)(data, 128),
  Blake2_128Concat: data => // eslint-disable-line @typescript-eslint/camelcase
  (0, _util.u8aConcat)((0, _utilCrypto.blake2AsU8a)(data, 128), (0, _util.u8aToU8a)(data)),
  Blake2_256: data => // eslint-disable-line @typescript-eslint/camelcase
