...
describe('substrate', () => {
  ...
  it('authorityCount should return the correct storage key', () => {
    expect((0, _substrate.authorityCount)(registry, 8)()).toEqual(Uint8Array.from([36, 58, 97, 117, 116, 104, 58, 108, 101, 110])); // Length-prefixed
  });
  it('authorityPrefix should return the correct storage key', () => {
    expect((0, _substrate.authorityPrefix)(registry, 8)()).toEqual(Uint8Array.from([24, 58, 97, 117, 116, 104, 58])); // Length-prefixed
  });
