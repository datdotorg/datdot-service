...
export declare const authorityCount: (registry: Registry, metaVersion: number) => StorageEntry;
export declare const authorityPrefix: (registry: Registry, metaVersion: number) => StorageEntry;
