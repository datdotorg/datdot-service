...
function toV4(registry, _ref) {
  ...
  return (0, _codec.createType)(registry, 'MetadataV4', {
    modules: modules.map((_ref2) => {
      ...
      return (0, _codec.createType)(registry, 'ModuleMetadataV4', {
        calls,
        events,
        name,
        prefix,
