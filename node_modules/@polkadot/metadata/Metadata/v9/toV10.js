...
function createStorageHasher(registry, hasher) {
  ...
  if (hasher.toNumber() >= 2) {
    return (0, _types.createType)(registry, 'StorageHasherV10', hasher.toNumber() + 1);
  }

  return (0, _types.createType)(registry, 'StorageHasherV10', hasher);
}

function createStorageType(registry, entryType) {
  if (entryType.isMap) {
    return [_objectSpread({}, entryType.asMap, {
      hasher: createStorageHasher(registry, entryType.asMap.hasher)
    }), 1];
  }

  if (entryType.isDoubleMap) {
    return [_objectSpread({}, entryType.asDoubleMap, {
