...
class Keyring {
  constructor() {
    ...
    this.setSS58Format = _utilCrypto.setSS58Format;
    options.type = options.type || 'ed25519';
    options.ss58Format = (0, _util.isNumber)(options.ss58Format) ? options.addressPrefix : options.ss58Format;
    ...
    if ((0, _util.isNumber)(options.ss58Format)) {
      (0, _utilCrypto.setSS58Format)(options.ss58Format);
    }
  }
  /**
  ...
  createFromUri(_suri) {
    ...
    const suri = _suri.startsWith('//') ? "".concat(_defaults.DEV_PHRASE).concat(_suri) : _suri;
    const {
      password,
      phrase,
      path
