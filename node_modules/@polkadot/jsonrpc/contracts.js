...
const call = {
  ...
  isOptional: true,
  params: [(0, _param.default)('callRequest', 'ContractCallRequest'), (0, _param.default)('at', 'BlockHash', {
    isOptional: true
  })],
...
const getStorage = {
  ...
  isOptional: true,
  params: [(0, _param.default)('address', 'AccountId'), (0, _param.default)('key', 'H256'), (0, _param.default)('at', 'BlockHash', {
    isOptional: true
  })],
  type: 'Option<Bytes>'
};
