...
const call = {
  ...
  params: [(0, _param.default)('method', 'Text'), (0, _param.default)('data', 'Bytes'), (0, _param.default)('at', 'BlockHash', {
    isOptional: true
  })],
  type: 'Bytes'
};
const KEY_QUERY_PARAMS = [(0, _param.default)('key', 'StorageKey'), (0, _param.default)('at', 'BlockHash', {
  isOptional: true
})];
const getKeys = {
...
const CHILD_QUERY_PARAMS = [(0, _param.default)('childStorageKey', 'StorageKey'), (0, _param.default)('childDefinition', 'StorageKey'), (0, _param.default)('childType', 'u32'), (0, _param.default)('key', 'StorageKey'), (0, _param.default)('at', 'BlockHash', {
  isOptional: true
})];
const getChildKeys = {
...
const getMetadata = {
  ...
  params: [(0, _param.default)('at', 'BlockHash', {
    isOptional: true
  })],
...
const queryStorage = {
  ...
  params: [(0, _param.default)('keys', 'Vec<StorageKey>'), (0, _param.default)('startBlock', 'Hash'), (0, _param.default)('at', 'BlockHash', {
    isOptional: true
  })],
