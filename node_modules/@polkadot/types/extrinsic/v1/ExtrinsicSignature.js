...
class ExtrinsicSignatureV1 extends _Struct.default {
  ...
  addSignature(signer, signature, payload) {
    return this.injectSignature(this.registry.createType('Address', signer), this.registry.createType('Signature', signature), new _ExtrinsicPayload.default(this.registry, payload));
  }
  /**
