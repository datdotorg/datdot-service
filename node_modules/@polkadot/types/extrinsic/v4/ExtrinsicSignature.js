...
class ExtrinsicSignatureV4 extends _Struct.default {
  ...
  addSignature(signer, signature, payload) {
    return this.injectSignature(this.registry.createType('Address', signer), this.registry.createType('MultiSignature', signature), new _ExtrinsicPayload.default(this.registry, payload));
  }
  /**
