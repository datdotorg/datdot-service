...
class AbstractInt extends _bn.default {
  constructor(registry, isSigned, value = 0, bitLength = DEFAULT_UINT_BITS, isHexJson = true) {
    ...
    (0, _util.assert)(super.bitLength() <= bitLength, "".concat(this.toRawType(), ": Input too large. Found input with ").concat(super.bitLength(), " bits, expected ").concat(bitLength));
  }
  /**
