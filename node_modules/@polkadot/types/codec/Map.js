...
class CodecMap extends Map {
  ...
  toRawType() {
    return "".concat((0, _classPrivateFieldLooseBase2.default)(this, _type)[_type], "<").concat(new ((0, _classPrivateFieldLooseBase2.default)(this, _KeyClass)[_KeyClass])(this.registry).toRawType(), ",").concat(new ((0, _classPrivateFieldLooseBase2.default)(this, _ValClass)[_ValClass])(this.registry).toRawType(), ">");
  }
  /**
