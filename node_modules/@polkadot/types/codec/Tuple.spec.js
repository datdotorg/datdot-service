...
describe('Tuple', () => {
  ...
  it('creates properly via actual hex string', () => {
    ...
    const test = new (_Tuple.default.with([(0, _create.ClassOf)(registry, 'BlockNumber'), (0, _create.ClassOf)(registry, 'VoteThreshold')]))(registry, '0x6219000001');
  ...
  it('exposes the Types (object creation)', () => {
    const test = new _Tuple.default(registry, {
      ...
      VoteThreshold: (0, _create.ClassOf)(registry, 'VoteThreshold')
    }, []);
  ...
  describe('toRawType', () => {
    it('generates sane value with array types', () => {
      expect(new _Tuple.default(registry, [_U2.default, (0, _create.ClassOf)(registry, 'BlockNumber')]).toRawType()).toEqual('(u128,u32)');
    });
    it('generates sane value with object types', () => {
      expect(new _Tuple.default(registry, {
        number: _U2.default,
        blockNumber: (0, _create.ClassOf)(registry, 'BlockNumber')
