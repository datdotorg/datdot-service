...
describe('BTreeMap', () => {
  describe('decoding', () => {
    const testDecode = (type, input, output) => it("can decode from ".concat(type), () => {
      const s = new _BTreeMap.default(registry, _Text.default, _U.default, input);
  ...
  describe('encoding', () => {
    const testEncode = (to, expected) => it("can encode ".concat(to), () => {
      const s = new _BTreeMap.default(registry, _Text.default, _U.default, mockU32TextMap);
  ...
  describe('encoding muple values', () => {
    const testEncode = (to, expected) => it("can encode ".concat(to), () => {
      const s = new _BTreeMap.default(registry, _Text.default, _U.default, mockU32U32Map);
      expect(s[to]()).toEqual(expected);
    });
  ...
  it('decodes within more complicated types', () => {
    ...
    s.set('value', new _BTreeMap.default(registry, _Text.default, _U.default, mockU32TextMap));
    expect(s.toString()).toBe('{"placeholder":0,"value":{"bazzing":69}}');
  });
  it('throws when it cannot decode', () => {
    expect(() => new (_BTreeMap.default.with(_Text.default, _U.default))(registry, 'ABC')).toThrowError(/BTreeMap: cannot decode type/);
  });
