...
describe('Option', () => {
  ...
  describe('utils', () => {
    const testeq = new _Option.default(registry, _Text.default, '1234');
    it('compares against other option', () => {
      expect(testeq.eq(new _Option.default(registry, _Text.default, '1234'))).toBe(true);
    });
    it('compares against raw value', () => {
      expect(testeq.eq('1234')).toBe(true);
    });
    it('unwraps to default if empty', () => {
      expect(new _Option.default(registry, _Text.default).unwrapOr('6789')).toBe('6789');
    });
    it('unwraps to value if non-empty', () => {
      expect(new _Option.default(registry, _Text.default, '1234').unwrapOr(null).toString()).toBe('1234');
    });
  });
});