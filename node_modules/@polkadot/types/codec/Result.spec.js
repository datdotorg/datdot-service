...
describe('Result', () => {
  ...
  it('returns a proper raw typedef rom a built-in', () => {
    expect((0, _create.createType)(registry, 'DispatchResult').toRawType()).toEqual('Result<Null,{"_enum":{"Other":"Null","CannotLookup":"Null","BadOrigin":"Null","Module":"{\\"index\\":\\"u8\\",\\"error\\":\\"u8\\"}"}}>');
  });
});