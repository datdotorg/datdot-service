...
function decodeSetNumber(setValues, _value) {
  ...
  (0, _util.assert)(bn.eq(computed), "Set: Mismatch decoding '".concat(bn, "', computed as '").concat(computed, "' with ").concat(result));
  return result;
}
/** @internal */
...
class CodecSet extends Set {
  constructor(registry, setValues, value, bitLength = 8) {
    ...
    this.add = key => {
      ...
      (0, _util.assert)((0, _util.isUndefined)((0, _classPrivateFieldLooseBase2.default)(this, _allowed)[_allowed]) || !(0, _util.isUndefined)((0, _classPrivateFieldLooseBase2.default)(this, _allowed)[_allowed][key]), "Set: Invalid key '".concat(key, "' on add"));
      super.add(key);
      return this;
    };
