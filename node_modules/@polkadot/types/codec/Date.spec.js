...
describe('Date', () => {
  ...
  describe('decode', () => {
    const testDecode = (type, input, expected, toJSON = false) => it("can decode from ".concat(type), () => {
  ...
  describe('encode', () => {
    ...
    it('can encode toString', () => {
      expect(new _Date.default(registry, 421).toString().startsWith('Thu Jan 01 1970') // The time depends on the timezone this test is run in
      ).toBe(true);
    });
