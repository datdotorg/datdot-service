...
class ExtrinsicSignatureV1 extends _Struct.default {
  ...
  get tip() {
    return (0, _create.createType)(this.registry, 'Compact<Balance>', 0);
  }

  injectSignature(signer, signature, {
    era,
    nonce
  }) {
    this.set('era', era);
  ...
  addSignature(signer, signature, payload) {
    return this.injectSignature((0, _create.createType)(this.registry, 'Address', signer), (0, _create.createType)(this.registry, 'Signature', signature), new _ExtrinsicPayload.default(this.registry, payload));
  }
  /**
  ...
  sign(method, account, {
    ...
    const signer = (0, _create.createType)(this.registry, 'Address', account.publicKey);
    const payload = new _ExtrinsicPayload.default(this.registry, {
      blockHash,
    ...
    const signature = (0, _create.createType)(this.registry, 'Signature', payload.sign(account));
