...
const registry = new _codec.TypeRegistry(); // eslint-disable-next-line no-new
...
describe('SignerPayload', () => {
  ...
  it('creates a valid JSON output', () => {
    expect(new _SignerPayload.default(registry, {
      ...
      era: (0, _types.createType)(registry, 'ExtrinsicEra', {
        current: 2301232,
        period: 200
      }),
      genesisHash: '0xdcd1346701ca8396496e52aa2785b1748deb6db09551b72159dcb3e08991025b',
      method: (0, _types.createType)(registry, 'Call', '0x0600ffd7568e5f0a7eda67a82691ff379ac4bba4f9c9b859fe779b5d46363b61ad2db9e56c'),
      nonce: 0x1234,
      tip: 0x5678,
      version: 3
    }).toPayload()).toEqual({
  ...
  it('re-constructs from JSON', () => {
    expect(new _SignerPayload.default(registry, TEST).toPayload()).toEqual(TEST);
  });
  it('re-constructs from itself', () => {
    expect(new _SignerPayload.default(registry, new _SignerPayload.default(registry, TEST)).toPayload()).toEqual(TEST);
  });
  it('can be used as a feed to ExtrinsicPayload', () => {
    const signer = new _SignerPayload.default(registry, TEST).toPayload();
    const payload = (0, _types.createType)(registry, 'ExtrinsicPayload', signer, {
