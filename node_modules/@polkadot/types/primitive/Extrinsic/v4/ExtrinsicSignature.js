...
class ExtrinsicSignatureV4 extends _Struct.default {
  ...
  addSignature(signer, signature, payload) {
    return this.injectSignature((0, _create.createType)(this.registry, 'Address', signer), (0, _create.createType)(this.registry, 'MultiSignature', signature), new _ExtrinsicPayload.default(this.registry, payload));
  }
  /**
  ...
  sign(method, account, {
    ...
    const signature = (0, _create.createType)(this.registry, 'MultiSignature', payload.sign(account));
