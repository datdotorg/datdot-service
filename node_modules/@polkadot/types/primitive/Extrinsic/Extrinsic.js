...
class Extrinsic extends _Base.default {
  ...
  static newFromValue(registry, value, version) {
    ...
    return (0, _create.createType)(registry, type, value, {
      isSigned,
      version
    });
  }

  static decodeExtrinsic(registry, value, version = _constants.DEFAULT_VERSION) {
    ...
    } else if (value instanceof (0, _create.ClassOf)(registry, 'Call')) {
      return Extrinsic.newFromValue(registry, {
        method: value
      }, version);
    }
  ...
  static decodeU8aLike(registry, value, version) {
    ...
    return Extrinsic.decodeU8a(registry, withPrefix ? u8a : _Compact.default.addLengthPrefix(u8a), version);
  }
