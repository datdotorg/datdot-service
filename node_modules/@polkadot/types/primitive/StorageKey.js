...
function getStorageType(type, isOptionalLinked) {
  ...
  if (map.linked.isTrue) {
    ...
    return [true, "(".concat(pre).concat(map.value.toString()).concat(post, ", Linkage<").concat(map.key.toString(), ">)")];
  }
...
class StorageKey extends _Bytes.default {
  ...
  constructor(registry, value, override = {}) {
    ...
    this._section = override.section || section; // decode the args (as applicable based on the key and the hashers, after all init)
