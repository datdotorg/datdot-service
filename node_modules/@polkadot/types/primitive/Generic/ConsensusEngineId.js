...
class ConsensusEngineId extends _U.default {
  ...
  getAuraAuthor(bytes, sessionValidators) {
    return sessionValidators[(0, _create.createType)(this.registry, 'RawAuraPreDigest', bytes.toU8a(true)).slotNumber.modn(sessionValidators.length)];
  }

  getBabeAuthor(bytes, sessionValidators) {
    const digest = (0, _create.createType)(this.registry, 'RawBabePreDigestCompat', bytes.toU8a(true));
