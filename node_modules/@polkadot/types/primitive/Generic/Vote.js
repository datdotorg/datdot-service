...
class Vote extends _U8aFixed.default {
  constructor(registry, value) {
    ...
    this._conviction = (0, _create.createType)(this.registry, 'Conviction', decoded[0] & CON_MASK);
  }

  static decodeVote(registry, value) {
    if ((0, _util.isUndefined)(value)) {
      return Vote.decodeVoteBool(false);
    } else if (value instanceof Boolean || (0, _util.isBoolean)(value)) {
      return Vote.decodeVoteBool(new _Bool.default(registry, value).isTrue);
    ...
    const conviction = (0, _create.createType)(registry, 'Conviction', (0, _util.isUndefined)(value.conviction) ? DEF_CONV : value.conviction);
