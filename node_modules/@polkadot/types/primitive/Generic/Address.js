...
class Address extends _Base.default {
  ...
  static decodeAddress(registry, value) {
    if (value instanceof _AccountId.default || value instanceof _AccountIndex.default) {
      ...
      return (0, _create.createType)(registry, 'AccountIndex', value);
    } else if (Array.isArray(value) || (0, _util.isHex)(value) || (0, _util.isU8a)(value)) {
      return Address.decodeU8a(registry, (0, _util.u8aToU8a)(value));
    }

    return Address.decodeString(registry, value);
  }

  static decodeString(registry, value) {
    const decoded = (0, _utilCrypto.decodeAddress)(value);
    return decoded.length === 32 ? (0, _create.createType)(registry, 'AccountId', decoded) : (0, _create.createType)(registry, 'AccountIndex', (0, _util.u8aToBn)(decoded, true));
  }

  static decodeU8a(registry, value) {
    // This allows us to instantiate an address with a raw publicKey. Do this first before
    // we checking the first byte, otherwise we may split an already-existent valid address
    if (value.length === 32) {
      return (0, _create.createType)(registry, 'AccountId', value);
    } else if (value[0] === 0xff) {
      return (0, _create.createType)(registry, 'AccountId', value.subarray(1));
    }

    const [offset, length] = _AccountIndex.default.readLength(value);

    return (0, _create.createType)(registry, 'AccountIndex', (0, _util.u8aToBn)(value.subarray(offset, offset + length), true));
  }
  /**
