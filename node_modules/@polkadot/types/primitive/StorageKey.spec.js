...
describe('StorageKey', () => {
  ...
  describe('with MetadataV11', () => {
    ...
    it('should allow decoding of a DoubleMap key', () => {
      ...
      expect(key.args.map(arg => arg.toHuman())).toEqual(['16', '5GNJqTPyNqANBkUVMN1LPPrxXnFouWXoe2wNSmmEoLctxiZY']);
    });
    it('should allow decoding of a Map key', () => {
      ...
      expect(key.args.map(arg => arg.toHuman())).toEqual(['5D4yQHKfqCQYThhHmTfN1JEDi47uyDJc1xg9eZfAG1R7FC7J']);
    });
  });
});