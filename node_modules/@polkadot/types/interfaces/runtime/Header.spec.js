...
describe('Header', () => {
  ...
  it('decodes an actual JSON response', () => {
    const header = (0, _create.createType)(registry, 'Header', _Header.default.result);
  ...
  it('parses old-style JSON headers (deprecated)', () => {
    const header = (0, _create.createType)(registry, 'Header', _Header2.default.result);
    expect(header.digest.logs).toHaveLength(1);
  });
  it('creates a valid hash (incl. digest & compact)', () => {
    const header = (0, _create.createType)(registry, 'Header', _Header3.default.result);
  ...
  it('calculates correct hash, matching with parentHash', () => {
    const blockHash = (0, _create.createType)(registry, 'Header', _SignedBlock.default.result.block.header).hash.toHex();
