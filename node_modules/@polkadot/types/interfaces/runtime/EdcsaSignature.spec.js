...
describe('EdcsaSignature', () => {
  ...
  it('constructs and has a valid representation (toHex)', () => {
    expect((0, _create.createType)(registry, 'EcdsaSignature', TESTS[0]).toHex()).toEqual(TESTS[0]);
  });
  it('constructs and has a valid representation (toJSON)', () => {
    expect((0, _create.createType)(registry, 'EcdsaSignature', TESTS[0]).toJSON()).toEqual(TESTS[0]);
  });
  it('constructs and has a valid representation (toU8a)', () => {
    expect((0, _create.createType)(registry, 'EcdsaSignature', TESTS[1]).toU8a()).toEqual((0, _util.hexToU8a)(TESTS[1]));
  });
});