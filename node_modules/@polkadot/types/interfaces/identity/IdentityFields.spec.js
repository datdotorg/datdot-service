...
describe('IdentityFields', () => {
  ...
  it('encodes to a valid u8a value', () => {
    expect(registry.createType('IdentityFields', ['Display', 'Legal']).toU8a()).toEqual(new Uint8Array([0, 0, 0, 0, 0, 0, 0, 3]));
  });
  it('decodes from a u8a', () => {
    expect(registry.createType('IdentityFields', new Uint8Array([0, 0, 0, 0, 0, 0, 0, 1 + 2 + 64])).toHuman()).toEqual(['Display', 'Legal', 'Image']);
  });
});