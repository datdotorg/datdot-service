...
describe('StorageChangeSet', () => {
  ...
  describe('construction', () => {
    const set = (0, _types.createType)(registry, 'StorageChangeSet', {
      block: '0x1234',
      changes: [['0xab', '0xcd']]
    });
    it('wraps blockHash', () => {
  ...
  describe('json', () => {
    const set = (0, _types.createType)(registry, 'StorageChangeSet', _StorageChangeSet.default.params.result);
