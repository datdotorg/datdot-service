...
const UNCONSTRUCTABLE = ['ExtrinsicPayloadUnknown', 'GenericExtrinsicPayloadUnknown', 'ExtrinsicUnknown', 'GenericExtrinsicUnknown', 'GenericOrigin', 'Origin', 'Unconstructable', 'usize'].map(v => v.toLowerCase());
...
describe('type creation', () => {
  ...
  Object.entries(definitions).forEach(([name, {
    types
  }]) => testTypes("".concat(name, " (injected)"), Object.keys(types)));
});