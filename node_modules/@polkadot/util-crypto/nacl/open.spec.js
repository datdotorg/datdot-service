...
describe('naclOpen', () => {
  ...
  it('polkadot does double ratchet', () => {
    ...
    console.log("Receiver sends receiver's public key to sender ".concat(receiverIdBoxKey.publicKey)); // Sender encrypts message to send with the public key the receiver sent and send it to receiver
    ...
    console.log("Sender sends encrypted message to receiver ".concat(sealed, ", ").concat(nonce)); // Receiver opens encrypted message from the sender

    let opened = (0, _.naclOpen)(sealed, nonce, senderIdBoxKey.publicKey, receiverIdBoxKey.secretKey);
    console.log("The sealed message is ".concat(opened)); // Oh no the Id key is hacked, derive Id key again from another index
    ...
    console.log("Receiver sends receiver's public key to sender ".concat(receiverIdBoxKey2.publicKey)); // Sender encrypts message to send with the public key the receiver sent and send it to receiver
    ...
    console.log("The sealed message is ".concat(opened)); // This time derive key for each message to send and receive
    ...
    console.log("Receiver sends receiver's public key to sender ".concat(receiverIdBoxKey2One.publicKey)); // Sender encrypts message to send with the public key the receiver sent and send it to receiver
    ...
    console.log("Sender sends encrypted message to receiver ".concat(sealed3, ", ").concat(nonce3)); // Receiver opens encrypted message from the sender

    opened = (0, _.naclOpen)(sealed2, nonce2, senderIdBoxKey2One.publicKey, receiverIdBoxKey2One.secretKey);
    console.log("The sealed message is ".concat(opened));
  });
