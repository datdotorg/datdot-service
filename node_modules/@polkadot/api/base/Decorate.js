...
class Decorate extends _Events.default {
  ...
  retrieveMapEntries(creator) {
    return this.retrieveMapData(creator).pipe((0, _operators.map)((_ref12) => {
      let [keys, values] = _ref12;
  ...
  decorateStoragePrefixed(creator, decorateMethod) {
    ...
    return decorateMethod(function () {
      ...
      return args.length ? _this3._rpcCore.state.subscribeStorage([[creator, ...args]]).pipe((0, _operators.map)((_ref13) => {
        let [data] = _ref13;
        return data;
      })) : _this3.retrieveMapData(creator).pipe((0, _operators.map)((_ref14) => {
        let [, values] = _ref14;
        return values;
      }));
    });
