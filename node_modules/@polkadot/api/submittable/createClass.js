...
function createClass({
  ...
  var _temp, _ignoreStatusCb, _getPrelimState, _makeEraOptions, _makeSignOptions, _makeSignAndSendOptions, _observeSign, _observeStatus, _observeSend, _observeSubscribe, _optionsOrNonce, _signViaSigner, _updateSigner;
  ...
  return _temp = class Submittable extends ExtrinsicBase {
    constructor(registry, extrinsic) {
      ...
      Object.defineProperty(this, _getPrelimState, {
        writable: true,
        value: (address, options) => {
          return (0, _rxjs.combineLatest)([// if we have a nonce already, don't retrieve the latest, use what is there
          (0, _util.isUndefined)(options.nonce) ? api.derive.balances.account(address).pipe((0, _operators.map)(({
            accountNonce
          }) => accountNonce)) : (0, _rxjs.of)(this.registry.createType('Index', options.nonce)), // if we have an era provided already or eraLength is <= 0 (immortal)
          // don't get the latest block, just pass null, handle in mergeMap
          (0, _util.isUndefined)(options.era) || (0, _util.isNumber)(options.era) && options.era > 0 ? api.rpc.chain.getHeader() : (0, _rxjs.of)(null)]);
        }
      });
      ...
      Object.defineProperty(this, _observeSign, {
        ...
        value: (account, optionsOrNonce) => {
          ...
          let updateId;
          return (0, _classPrivateFieldLooseBase2.default)(this, _getPrelimState)[_getPrelimState](address, options).pipe((0, _operators.first)(), (0, _operators.mergeMap)(async ([nonce, header]) => {
            const eraOptions = (0, _classPrivateFieldLooseBase2.default)(this, _makeEraOptions)[_makeEraOptions](options, {
              header,
              nonce
            });
            ...
            if ((0, _util2.isKeyringPair)(account)) {
              ...
              updateId = await (0, _classPrivateFieldLooseBase2.default)(this, _signViaSigner)[_signViaSigner](address, eraOptions, header);
            }
      ...
      Object.defineProperty(this, _observeStatus, {
        ...
        value: status => {
          ...
          return (0, _rxjs.combineLatest)([api.rpc.chain.getBlock(blockHash), api.query.system.events.at(blockHash)]).pipe((0, _operators.map)(([signedBlock, allEvents]) => new _Result.default({
            events: (0, _util2.filterEvents)(this.hash, signedBlock, allEvents, status),
            status
          })));
        }
      });
      ...
      Object.defineProperty(this, _observeSubscribe, {
        writable: true,
        value: (updateId = -1) => {
          return api.rpc.author.submitAndWatchExtrinsic(this).pipe((0, _operators.switchMap)(status => (0, _classPrivateFieldLooseBase2.default)(this, _observeStatus)[_observeStatus](status)), (0, _operators.tap)(status => {
      ...
      Object.defineProperty(this, _signViaSigner, {
        ...
        value: async (address, options, header) => {
          ...
          const payload = this.registry.createType('SignerPayload', _objectSpread({}, options, {
            address,
            method: this.method,
    ...
    paymentInfo(account, options) {
      ...
      const address = (0, _util2.isKeyringPair)(account) ? account.address : account.toString();
      return decorateMethod(() => (0, _classPrivateFieldLooseBase2.default)(this, _getPrelimState)[_getPrelimState](address, allOptions).pipe((0, _operators.first)(), (0, _operators.switchMap)(([nonce, header]) => {
        // setup our options (same way as in signAndSend)
        const eraOptions = (0, _classPrivateFieldLooseBase2.default)(this, _makeEraOptions)[_makeEraOptions](allOptions, {
          header,
          nonce
        });
    ...
    signAndSend(account, optionsOrStatus, optionalStatusCb) {
      ...
      const isSubscription = api.hasSubscriptions && ((0, _classPrivateFieldLooseBase2.default)(this, _ignoreStatusCb)[_ignoreStatusCb] || !!statusCb);
