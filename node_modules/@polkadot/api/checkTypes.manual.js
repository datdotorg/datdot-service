...
async function query(api, keyring) {
  ...
  console.log("Received ".concat(events.length, " events:")); // check entries()
  ...
  console.log("Received ".concat(entries.length, " entries, ").concat(entries.map(([hash, events]) => "".concat(hash.toHex(), ": ").concat(events.length, " events"))));
}
