...
function types() {
  ...
  const balance = (0, _codec.createType)(registry, 'Balance', 2);
  const gas = (0, _codec.createType)(registry, 'Gas', 2);
  const compact = (0, _codec.createType)(registry, 'Compact<u32>', 2); // const random = createType(registry, 'RandomType', 2); // This one should deliberately show a TS error

  const gasUnsafe = (0, _codec.createTypeUnsafe)(registry, 'Gas', [2]);
  const overriddenUnsafe = (0, _codec.createTypeUnsafe)(registry, 'Gas', [2]);
