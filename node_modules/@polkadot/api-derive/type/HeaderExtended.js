...
class HeaderExtended extends _Header {
  constructor(registry, header, sessionValidators) {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _author)[_author] = this.extractAuthor(sessionValidators);
  }

  extractAuthor(sessionValidators = []) {
  ...
  toHuman(isExtended) {
    return _objectSpread({}, super.toHuman(isExtended), {
