...
function createDerivedV1(api, [bestNumber, {
  currentIndex,
  validatorCount
}, [_lastLengthChange, sessionLength, lastEraLengthChange, sessionsPerEra]]) {
...
function createDerivedLatest(api, [[hasBabe, epochDuration, sessionsPerEra], {
  currentIndex,
  currentEra,
  validatorCount
...
function infoLatestBabe(api) {
  return (0, _rxjs.combineLatest)([api.derive.session.indexes(), api.queryMulti([api.query.babe.currentSlot, api.query.babe.epochIndex, api.query.babe.genesisSlot, api.query.staking.currentEraStartSessionIndex])]).pipe((0, _operators.map)(([indexes, slots]) => createDerivedLatest(api, [[true, api.consts.babe.epochDuration, api.consts.staking.sessionsPerEra], indexes, slots])));
}
/**
