...
function retrieveProposals(api, proposalCount, approvalIds) {
  ...
  (0, _rxjs.combineLatest)(allIds.map(id => api.query.treasury.proposals(id))), api.derive.council.proposals()]).pipe((0, _operators.map)(([allProposals, councilProposals]) => parseResult(api, {
    allIds,
    allProposals,
    approvalIds,
    councilProposals,
