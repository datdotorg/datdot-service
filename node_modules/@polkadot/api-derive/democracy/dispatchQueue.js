...
function queryScheduler(api) {
  ...
  }), (0, _operators.map)(([infos, images]) => infos.map((info, index) => _objectSpread({}, info, {
    image: images[index]
  }))));
}
...
function dispatchQueue(api) {
  return (0, _util2.memo)(() => {
    ...
    return ((_api$query$scheduler = api.query.scheduler) === null || _api$query$scheduler === void 0 ? void 0 : _api$query$scheduler.agenda) ? queryScheduler(api) : api.query.democracy.dispatchQueue ? queryQueue(api) : (0, _rxjs.of)([]);
  });
}