...
function redeemableSum(api, stakingLedger, sessionInfo) {
  ...
  return (0, _types.createType)(api.registry, 'Balance', stakingLedger.unlocking.reduce((total, {
    era,
    value
  }) => {
...
function account(api) {
  return (0, _util2.memo)(accountId => (0, _rxjs.combineLatest)([api.derive.session.info(), api.derive.staking.query(accountId)]).pipe((0, _operators.map)(([sessionInfo, query]) => parseResult(api, sessionInfo, query))));
}