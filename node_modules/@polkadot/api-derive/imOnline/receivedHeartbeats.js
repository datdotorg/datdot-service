...
function receivedHeartbeats(api) {
  return (0, _util.memo)(() => {
    ...
    return ((_api$query$imOnline = api.query.imOnline) === null || _api$query$imOnline === void 0 ? void 0 : _api$query$imOnline.receivedHeartbeats) && api.query.imOnline.authoredBlocks ? api.derive.staking.overview().pipe((0, _operators.switchMap)(({
      currentIndex,
      validators
