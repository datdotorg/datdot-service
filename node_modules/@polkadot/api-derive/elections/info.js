...
function queryElections(api) {
  ...
  return (0, _rxjs.combineLatest)([api.query[section].candidates(), api.query[section].members(), api.query[section].runnersUp()]).pipe((0, _operators.map)(([candidates, members, runnersUp]) => deriveElections(api, candidates, members, runnersUp, api.consts[section].candidacyBond, api.consts[section].desiredMembers, api.consts[section].termDuration, api.consts[section].votingBond)));
}
/**
 * @name info
