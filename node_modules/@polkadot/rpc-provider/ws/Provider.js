...
class WsProvider {
   ...
   */
  constructor(endpoint = _defaults.default.WS_URL, autoConnect = true) {
    ...
    Object.defineProperty(this, _autoConnect, {
      writable: true,
      value: void 0
    });
    ...
    Object.defineProperty(this, _onSocketClose, {
      writable: true,
      value: event => {
        if ((0, _classPrivateFieldLooseBase2.default)(this, _autoConnect)[_autoConnect]) {
          l.error("disconnected from ".concat((0, _classPrivateFieldLooseBase2.default)(this, _endpoint)[_endpoint], " code: '").concat(event.code, "' reason: '").concat(event.reason, "'"));
        }
      ...
      value: response => {
        ...
        try {
          ...
          if (subscription) {
            ...
            (0, _classPrivateFieldLooseBase2.default)(this, _subscriptions)[_subscriptions][subId] = _objectSpread({}, subscription, {
              method,
              params
    ...
    Object.defineProperty(this, _onSocketOpen, {
      ...
      value: () => {
        ...
        l.debug(() => ['connected to', (0, _classPrivateFieldLooseBase2.default)(this, _endpoint)[_endpoint]]);
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _autoConnect)[_autoConnect] = autoConnect;
  ...
  clone() {
    return new WsProvider((0, _classPrivateFieldLooseBase2.default)(this, _endpoint)[_endpoint]);
  }
  /**
  ...
  async connect() {
    try {
      ...
      (0, _classPrivateFieldLooseBase2.default)(this, _websocket)[_websocket] = new WS((0, _classPrivateFieldLooseBase2.default)(this, _endpoint)[_endpoint]);
  ...
  disconnect() {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _autoConnect)[_autoConnect] = false; // 1000 - Normal closure; the connection successfully completed
...
var _autoConnect = (0, _classPrivateFieldLooseKey2.default)("autoConnect");
