...
function _formatBalance(input, options = true, optDecimals = defaultDecimals) {
  ...
  const units = withSi || withSiFull ? si.value === '-' ? withUnit ? " ".concat((0, _boolean.default)(withUnit) ? si.text : withUnit) : '' : "".concat(withSiFull ? " ".concat(si.text) : si.value).concat(withUnit ? " ".concat((0, _boolean.default)(withUnit) ? _si.SI[_si.SI_MID].text : withUnit) : '') : '';
