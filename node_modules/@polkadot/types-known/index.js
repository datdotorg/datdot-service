...
function getMetadataTypes(_registry, version) {
  return filterVersions(_metadata.default, version);
}
/**
...
function getModuleTypes({
  ...
  return _objectSpread({}, _modules.default[section] || {}, {}, ((_knownTypes$typesAlia = knownTypes.typesAlias) === null || _knownTypes$typesAlia === void 0 ? void 0 : _knownTypes$typesAlia[section]) || {});
}
/**
