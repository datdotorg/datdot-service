...
Behavior:
- if no data in storage (fresh chain) -> no newPin events broadcasted
- if data already there -> newPin events broadcasted
(hypercore key same as when we first time ran the code
(the data that was published in that round), but account address always the same)
*/
