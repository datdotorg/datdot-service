  ...
  async function getProofs (components, datasets) {
    ...
    for (const dataset of datasets) {
      all.push(new Promise(async (resolve, reject) => {
        ...
        // make feed
        const { feed } = await hyper.new_task({ feedkey: keybuff, signal, log })
        ...
        await done_task_cleanup({ role: 'sponsor', peers: [remotestringkey], topic: feed.discoveryKey, state: account.state, log })
        resolve()
