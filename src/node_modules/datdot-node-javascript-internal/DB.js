...
// {
//   id,
//   type, // hostingSetup, retry_hostingSetup, hosterReplacement
//   contract: contractID,
//   providers: {
//     encoders,
//     hosters,
//     attesters
//   },
//   status: 'init'/'in progress'/'fail'/'done'
//   ref, // reference amendment (for hosterReplacement)
//   pos, // position of hoster and encoder replaced (for hosterReplacement)
//
// }
...
// `storage/:id/user/status/paused` // until when
  /*
  Fail
  Short Pause
  Long pause

  frozen = stopped = paused
  - difference is just how long
  */
// `storage/:id/user/encoder/tasks/task_id`

// `storage/:id/user/attester/tasks/task_id`

// `storage/:id/user/hoster/tasks/task_id`
// `storage/:id/user/hoster/challenge/status` // pending, done, fail, timed-out, unknown

// `storage/:id/user/balance`

// `storage/:id/user/rating`
// {
//   id, 776
