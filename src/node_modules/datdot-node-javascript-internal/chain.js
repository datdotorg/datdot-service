  ...
  try {
    ...
    if (res_status === 'fail') {
      ...
      for (const stringID of Object.keys(challenged_hoster.hoster.tasks)) {
        ...
        await dropHosting({ amendmentID, userID: challenged_hoster.id, type: 'hosting', status: 'pause', log })
...
async function cancelHostingJobs ({ user, log }) {
  ...
  for (const id of amendmentIDs) {
    await dropHosting({ amendmentID: id, userID: user.id, type: 'hosting', status: 'pause', log })
