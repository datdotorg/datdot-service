...
async function storage_challenge_timeout (log, data) {
  ...
  log({ type: 'storage-challenge', data: { text: 'error: storage challenge timeout', user: user.id, status: user.hoster.challenge.status, cid, perf: performance.now() - timestamp} })
