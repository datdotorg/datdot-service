  ...
  create: async ({ name, provider, ondisconnect, log }) => {
    ...
    const api = ({
      ...
      tx: { datVerify: {
        ...
        unpublishPlan: unpublishPlan.bind(name),
        hostingSetupReport: hostingSetupReport.bind(name),
        hosterReplacementReport: hosterReplacementReport.bind(name),
        submitStorageChallenge: submitStorageChallenge.bind(name),
        submitPerformanceChallenge: submitPerformanceChallenge.bind(name),
        pause: pause.bind(name),
        unpause: unpause.bind(name),
        }
      },
      rpc: {
...
async function unpublishPlan (...args) { return { signAndSend: signAndSend.bind({ name: this, args, type: 'unpublishPlan'}) } }
async function hostingSetupReport (...args) { return { signAndSend: signAndSend.bind({ name: this, args, type: 'hostingSetupReport'}) } }
async function hosterReplacementReport (...args) { return { signAndSend: signAndSend.bind({ name: this, args, type: 'hosterReplacementReport'}) } }
...
async function pause (...args) { return { signAndSend: signAndSend.bind({ name: this, args, type: 'pause'}) } }
async function unpause (...args) { return { signAndSend: signAndSend.bind({ name: this, args, type: 'unpause'}) } }
/******************************************************************************
  QUERIES
******************************************************************************/
