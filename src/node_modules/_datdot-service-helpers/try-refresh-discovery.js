...
async function try_refresh_discovery ({ swarm, topic, tasks, log }) {
	return new Promise(async (resolve, reject) => {
		...
		try {
      // NOTE: things don't get refreshed on the DHT in real time, so old mode
      // might still be active for a few more seconds
      // that is why we add additional checks in the onconnection cb
