...
async function try_refresh_discovery ({ swarm, topic, tasks, log }) {
	return new Promise(async (resolve, reject) => {
		...
		const { 
			author, sponsor, encoder2author, encoder2attester, attester2encoder, attester2hoster, hoster2author, hoster2attester, hoster2peers, perf_attester
		} = tasks 
		...
		const any_server_only = author || encoder2attester || attester2hoster || hoster2peers
		const no_server = !author && !encoder2attester && !attester2hoster && !hoster2peers
