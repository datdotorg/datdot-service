...
async function onmessage ({ message, remotestringkey, string_msg, cache }) {
	...
	if (type === 'feedkey') {	// make feed
		...
		replicate_to_target({ ontarget, feed, targets, replicationStream, remotestringkey, stringtopic, log })
	} 
...
function replicate_to_target ({ ontarget, feed, targets, replicationStream, remotestringkey, stringtopic, log }) {
