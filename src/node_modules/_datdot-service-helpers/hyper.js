		...
		for (const stringtopic of target_tasks) {
			try {	
				...
				if (connections[remotestringkey] && sockets[remotestringkey]) {  
					...
					console.log({ targets: Object.keys(targets), tasks: Object.keys(tasks), sockets: Object.keys(sockets), remotestringkey})
					continue
				}
				...
				console.log({ targets: JSON.stringify(targets), tasks: JSON.stringify(tasks), sockets: Object.keys(sockets)})
			}
		}
	} catch (err) {
