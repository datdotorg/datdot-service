...
module.exports = class FeedStorage {
  ...
  **/
  ...
  async storeEncoded ({ index, encoded_data_signature, encoded_data, unique_el, nodes }) {
    this.log({ type: 'hoster', data: { text: `Hoster storage - starting to store`, encoded_data: encoded_data.toString('hex') }})
  ...
  async getData (index, cb) {
    ...
    try {
      ...
      console.log({ text: 'got encoded data for', index, encoded_data })
      // Got encoded data!
    ...
    try {
      console.log({ text: 'got decoded version for', index, decoded: decoded.toString('hex') })
