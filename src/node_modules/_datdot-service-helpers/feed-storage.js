  ...
  **/
  constructor ({ db, feed, log }) {
    ...
    this.unintercept = intercept(feed, {
      getData: async (index) => this.getData(index),
      putData: async (index, data, offset) => this.putData(index, data, offset)
    })
  }
  ...
  async getData (index) {
    ...
    try {
      ...
      this.log({ type: 'storage', data: { text: 'Encoded is not yet stored', index }})
      try {
  ...
  async putData (index, data, offset) {
    ...
    try {
      ...
      this.log({ type: 'storage', data: { text: 'Already have encoded, here is decoded', decoded }})
      return
    } catch (error) {
      ...
      try {
        ...
        this.log({ type: 'storage', data: { text: `Error in putData`, index, err }})
        throw err
      }
    }
  }
