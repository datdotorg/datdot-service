...
function merkle_verify (publicKey, hash_index, version, signature, nodes) {
  ...
  if (!verify(nodes, roots, signature, publicKey, version)) return'checksum not verified'
...
function verify (nodes, roots, signature, publicKey, version) {
