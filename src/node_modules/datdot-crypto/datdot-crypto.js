...
function create_signing_keypair ({ namespace, seed, name }) {
  ...
  if (signingSeed) sodium.crypto_sign_seed_keypair(signingPublicKey, signingSecretKey, signingSeed)
  else sodium.crypto_sign_seed_keypair(signingPublicKey, signingSecretKey)
